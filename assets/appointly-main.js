if (!window.appointlyConfig) {
  window.appointlyConfig = {
    ...
    clientUniqueId: "LJ6GVT4GJ3ZWKEBUR6FFB9F1",
    booking: {
      bookingHtml: `<html>
<head>
  <meta charset='utf-8'>
